...
// CHECK-NEXT:     xbbpebble            1.0       'XBBPebble' (Buckyball Pebble core extension)
// CHECK-NEXT:     xbuckyball           1.0       'XBuckyball' (Buckyball custom instruction carrier)
...
// CHECK-NEXT:     xgemmini             1.0       'XGemmini' (Gemmini extension)
...
// CHECK-NEXT:     xsmtime              1.0       'XSMTIME' (SpacemiT IME extension)
...
// CHECK-NEXT:     xtheadmatrix         3.0       'XTHeadMatrix' (T-Head AME matrix extension)
// CHECK-NEXT:     xtheadmatrixmin      0.5       'XTHeadMatrixMin' (T-Head AME minimal matrix extension)
// CHECK-NEXT:     xtheadmdma           0.5       'XTHeadMDMA' (T-Head AME matrix DMA extension)
...
// CHECK-NEXT:     xtheadmew16b         0.5       'XTHeadMEW16B' (T-Head AME 16-bit element width extension)
// CHECK-NEXT:     xtheadmew32b         0.5       'XTHeadMEW32B' (T-Head AME 32-bit element width extension)
// CHECK-NEXT:     xtheadmew4b          0.5       'XTHeadMEW4B' (T-Head AME 4-bit element width extension)
// CHECK-NEXT:     xtheadmew64b         0.5       'XTHeadMEW64B' (T-Head AME 64-bit element width extension)
// CHECK-NEXT:     xtheadmew8b          0.5       'XTHeadMEW8B' (T-Head AME 8-bit element width extension)
// CHECK-NEXT:     xtheadmfew           0.5       'XTHeadMFEW' (T-Head AME matrix fractional element width extension)
// CHECK-NEXT:     xtheadmfic           0.5       'XTHeadMFIC' (T-Head AME matrix fixed-point conversion extension)
// CHECK-NEXT:     xtheadmhp            0.5       'XTHeadMHP' (T-Head AME matrix half precision extension)
// CHECK-NEXT:     xtheadmiew           0.5       'XTHeadMIEW' (T-Head AME matrix integer element width extension)
// CHECK-NEXT:     xtheadmmbf16bbf16b   0.5       'XTHeadMMBF16BBF16B' (T-Head AME BF16-by-BF16 matrix multiply extension)
// CHECK-NEXT:     xtheadmmbf16bf32b    0.5       'XTHeadMMBF16BF32B' (T-Head AME BF16-by-F32 matrix multiply extension)
// CHECK-NEXT:     xtheadmmbf20bf32b    0.5       'XTHeadMMBF20BF32B' (T-Head AME BF20-by-F32 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf16bf16b     0.5       'XTHeadMMF16BF16B' (T-Head AME F16-by-BF16 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf16bf32b     0.5       'XTHeadMMF16BF32B' (T-Head AME F16-by-F32 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf32bf32b     0.5       'XTHeadMMF32BF32B' (T-Head AME F32-by-F32 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf32bf64b     0.5       'XTHeadMMF32BF64B' (T-Head AME F32-by-F64 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf4bbf16b     0.5       'XTHeadMMF4BBF16B' (T-Head AME F4-by-BF16 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf4bf16b      0.5       'XTHeadMMF4BF16B' (T-Head AME F4-by-F16 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf4bf32b      0.5       'XTHeadMMF4BF32B' (T-Head AME F4-by-F32 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf64bf64b     0.5       'XTHeadMMF64BF64B' (T-Head AME F64-by-F64 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf8bbf16b     0.5       'XTHeadMMF8BBF16B' (T-Head AME F8-by-BF16 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf8bf16b      0.5       'XTHeadMMF8BF16B' (T-Head AME F8-by-F16 matrix multiply extension)
// CHECK-NEXT:     xtheadmmf8bf32b      0.5       'XTHeadMMF8BF32B' (T-Head AME F8-by-F32 matrix multiply extension)
// CHECK-NEXT:     xtheadmmi4bi32b      0.5       'XTHeadMMI4BI32B' (T-Head AME I4-by-I32 matrix multiply extension)
// CHECK-NEXT:     xtheadmmi8bi32b      0.5       'XTHeadMMI8BI32B' (T-Head AME I8-by-I32 matrix multiply extension)
// CHECK-NEXT:     xtheadmmmxf4b        0.5       'XTHeadMMMXF4B' (T-Head AME MXF4 matrix multiply extension)
// CHECK-NEXT:     xtheadmmmxf8b        0.5       'XTHeadMMMXF8B' (T-Head AME MXF8 matrix multiply extension)
// CHECK-NEXT:     xtheadmmmxf8bmxf4b   0.5       'XTHeadMMMXF8BMXF4B' (T-Head AME MXF8-by-MXF4 matrix multiply extension)
// CHECK-NEXT:     xtheadmred           0.5       'XTHeadMRED' (T-Head AME matrix reduction extension)
...
// CHECK-NEXT:     smijt                0.19      'Smijt' (Interrupt Jump Table at Machine Level)
