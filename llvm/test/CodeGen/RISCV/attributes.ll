...
; RUN: llc -mtriple=riscv32 -mattr=+experimental-ztt %s -o - | FileCheck --check-prefix=RV32ZTT %s
...
; RUN: llc -mtriple=riscv64 -mattr=+experimental-ztt %s -o - | FileCheck --check-prefix=RV64ZTT %s
...
; RV32ZTT: .attribute 5, "rv32i2p1_ztt0p1"
...
; RV64ZTT: .attribute 5, "rv64i2p1_ztt0p1"
